$(function() {
    ...
    $('.cell-calendar').droppable({
        drop: function(event, ui) {
            ...
            if(eventCell == 'fc-event-container ui-draggable')
            {
                ...
                var data = {date:data};
                var updateUrl = 'http://' + location.host + '/manager/offsets/' + id;
                $.ajax(
                    {
                        headers: {
    ...
    $('.fc-event-container').click(function(e)
    {
        ...
        var url = 'http://'+ location.host + '/manager/offsets/' + id + '/edit';
        var updateUrl = 'http://' + location.host + '/manager/offsets/' + id;
    ...
    $('#data-prev').click(function()
    {
        ...
        var updateUrl = 'http://' + location.host + '/manager/offsets/' + date;
    ...
    {
        var date = this.getAttribute('data-prev');
        var updateUrl = 'http://' + location.host + '/manager/offsets/';
        location.assign(updateUrl);
    });
