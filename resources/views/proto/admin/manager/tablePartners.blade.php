<section class="panel">
    <header class="panel-heading">
        ...
        <h2 class="panel-title">Список партнеров</h2>
    </header>
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-md">
                    <a href="{{route('partners.create')}}" id="addToTable" class="btn btn-primary">Добавить Партнера <i class="fa fa-plus"></i></a>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-editable">
            ...
            @foreach($clients as  $value)
                ...
                <tr class="gradeA">
                    ...
                    <td class="actions">
                        <a href="{{route('partners.show',['id'=> $value->id])}}" class="on-default show-row"><i class="el-icon-eye-open"></i></a>
                        <a href="{{route('partners.edit',['id'=> $value->id])}}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                        <a href="#" class="on-default remove-row" data-form-id="{{$value->id}}"><i class="fa fa-trash-o"></i></a>
                        <form action="{{route('partners.destroy',['id' => $value->id])}}"  data-form="{{$value->id}}" method="post">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        </form>
                    </td>
