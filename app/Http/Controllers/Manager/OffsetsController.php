...
class OffsetsController extends ManagerController
{
    ...
    public function index()
    {
        ...
        $content = view(config('settings.theme').'.admin.manager.tableOffsets')->with(['month'=>$month,'navigate'=> $navigate,'category' => $category])->render();
